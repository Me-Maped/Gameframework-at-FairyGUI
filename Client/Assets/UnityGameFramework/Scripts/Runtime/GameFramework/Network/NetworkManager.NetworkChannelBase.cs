...
namespace GameFramework.Network
{
    internal sealed partial class NetworkManager : GameFrameworkModule, INetworkManager
    {
        ...
        {
            private const float DefaultHeartBeatInterval = 20f;
            ...
            public NetworkChannelBase(string name, INetworkChannelHelper networkChannelHelper)
            {
                ...
                m_ReceivePacketPool = new EventPool<Packet>(EventPoolMode.AllowNoHandler);
            ...
            public void Close()
            {
                lock (this)
                {
                    ...
                    try
                    {
                        m_Socket.Shutdown(SocketShutdownType.Both);
                    }
                    catch
                    {
                    }
