    ...
    internal sealed partial class NetworkManager : GameFrameworkModule, INetworkManager
    {
        ...
        private sealed class TcpNetworkChannel : NetworkChannelBase
        {
            ...
            private void ReceiveAsync()
            {
                try
                {
                    ((SystemNetSocket)m_Socket).BeginReceive(m_ReceiveState.Stream.GetBuffer(), (int)m_ReceiveState.Stream.Position, (int)(m_ReceiveState.Stream.Length - m_ReceiveState.Stream.Position), SocketFlags.None, m_ReceiveCallback, m_Socket);
                }
                catch (Exception exception)
                {
                    m_Active = false;
